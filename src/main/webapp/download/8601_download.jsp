                ...
                <div class="row align-items-center">
                    ...
                    <ul class="list-unstyled mb-0 col-12 col-lg-4 text-dark-l1 text-90 text-left my-4 my-md-0">
                        <audio controls="" autoplay="" name="media" controlslist="nodownload">
                            <source src="<c:url value="/musicStore/mp3File/star.mp3"/>" type="audio/mp3">
                        </audio>
                    </ul>

                    <div class="col-12 col-lg-4 text-center">
                        <a href="<c:url value="/musicStore/mp3File/star.mp3"/>" target="_blank" download="star" class="f-n-hover btn btn-success btn-raised px-4 py-25 w-75 text-600">Download</a>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <ul class="list-unstyled mb-0 col-12 col-lg-4 text-dark-l1 text-90 text-left my-4 my-md-0">
                        <audio controls="" autostart="0" name="media" controlslist="nodownload">
                            <source src="/musicStore/mp3File/no_difference.mp3" type="audio/mp3">
                        </audio>
                    </ul>

                    <div class="col-12 col-lg-4 text-center">
                        <a href="/music_store/no_difference.mp3" target="_blank" download="no_difference" class="f-n-hover btn btn-warning btn-raised px-4 py-25 w-75 text-600">Download</a>
                    </div>
                </div>
            </div>
        </div>
